...
// Add sale amount to hand cash (after a sale)
const addSaleToHandCash = async (sale) => {
    try {
      ...
      console.log("Hand cash updated:", handCash);
    } catch (error) {
      console.error("Error updating hand cash:", error);
    }
  };
  
  // Controller to create a sale
  export const createSale = async (req, res) => {
    try {
      ...
      // Update hand cash with the sale amount
      await addSaleToHandCash(newSale); // Add the sale to the hand cash
